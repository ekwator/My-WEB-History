************************************************************
* Dynamic display block module theme: modest-grey10p       *
* Copyright(c) 2009 P. Blaauw All rights reserved.         *
* Version 1.2(16-AUG-2009)                                 *
* License: GPL                                             *
************************************************************
...
* Pager configurable on top or bottom.
* Number Pager contains links to the slides.

Theme directory structure
-------------------------

The modest-grey10p theme contains the following directories and files:
...
------ddblock-cycle-block-content-modest-grey10p.tpl.php
------ddblock-cycle-pager-content.tpl.php
------ddblock-cycle-pager-content-modest-grey10p.tpl.php
------images/
--------readmore.png
--------readmore-hover.png
--------transparent_bg.png
------modest-grey10p/
--------ddblock-cycle-modest-grey10p.css
...
3.) Type modest-grey10p as the custom template name
