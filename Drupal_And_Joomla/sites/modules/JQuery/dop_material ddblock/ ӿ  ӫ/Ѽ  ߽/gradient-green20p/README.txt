************************************************************
* Dynamic display block module theme: gradient-green20p    *
* Copyright(c) 2009 P. Blaauw All rights reserved.         *
* Version 1.4(04-OCT-2009)                                 *
...
The gradient-green20p theme contains the following directories and files:

gradient-green20p2.jpg
README.txt
custom/
--boxes/
----boxes.css
...
------ddblock-cycle-block-content-gradient-green20p.tpl.php
------ddblock-cycle-pager-content.tpl.php
------ddblock-cycle-pager-content-gradient-green20p.tpl.php
------images/
--------readmore.png
--------readmore-hover.png
--------transparent_bg.png
------gradient-green20p/
--------ddblock-cycle-gradient-green20p.css
...
3.) Type gradient-green20p as the custom template name
