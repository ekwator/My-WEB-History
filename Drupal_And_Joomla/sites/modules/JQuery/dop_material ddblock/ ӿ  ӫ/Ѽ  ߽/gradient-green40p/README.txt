************************************************************
* Dynamic display block module theme: gradient-green40p    *
* Copyright(c) 2009 P. Blaauw All rights reserved.         *
* Version 1.4(02-AUG-2009)                                 *
* License: GPL                                             *
************************************************************
...
The gradient-green40p theme contains the following directories and files:

gradient-green40p4.jpg
README.txt
custom/
--boxes/
----boxes.css
...
------ddblock-cycle-block-content-gradient-green40p.tpl.php
------ddblock-cycle-pager-content.tpl.php
------ddblock-cycle-pager-content-gradient-green40p.tpl.php
------images/
--------readmore.png
--------readmore-hover.png
--------transparent_bg.png
------gradient-green40p/
--------ddblock-cycle-gradient-green40p.css
...
3.) Type gradient-green40p as the custom template name
