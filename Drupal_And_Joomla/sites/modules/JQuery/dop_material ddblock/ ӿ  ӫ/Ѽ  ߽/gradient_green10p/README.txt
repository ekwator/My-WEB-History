************************************************************
* Dynamic display block module theme: gradient-green10p    *
* Copyright(c) 2009 P. Blaauw All rights reserved.         *
* Version 1.4 (23-AUG-2009)                                *
...
* Pager configurable on top and bottom.
* Number Pager contains links to the slides.

Theme directory structure
-------------------------

The gradient-green10p theme contains the following directories and files:

gradient-green10p1.jpg
README.txt
custom/
--boxes/
----boxes.css
...
------ddblock-cycle-block-content-gradient-green10p.tpl.php
------ddblock-cycle-pager-content.tpl.php
------ddblock-cycle-pager-content-gradient-green10p.tpl.php
------images/
--------readmore.png
--------readmore-hover.png
--------transparent_bg.png
------gradient-green10p/
--------ddblock-cycle-gradient-green10p.css
...
3.) Type gradient-green10p as the custom template name
