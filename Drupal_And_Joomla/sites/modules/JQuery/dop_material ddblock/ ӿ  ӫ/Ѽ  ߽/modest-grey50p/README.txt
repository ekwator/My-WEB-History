************************************************************
* Dynamic display block module theme: modest-grey50p       *
* Copyright(c) 2009 P. Blaauw All rights reserved.         *
* Version 1.3(22-NOV-2009)                                 *
************************************************************
...
The modest-grey50p theme contains the following directories and files:
...
------ddblock-cycle-block-content-modest-grey50p.tpl.php
------ddblock-cycle-pager-content.tpl.php
------ddblock-cycle-pager-content-modest-grey50p.tpl.php
------images/
--------readmore.png
--------readmore-hover.png
--------transparent_bg.png
------modest-grey50p/
--------ddblock-cycle-modest-grey50p.css
...
3.) Type modest-grey50p as the custom template name
