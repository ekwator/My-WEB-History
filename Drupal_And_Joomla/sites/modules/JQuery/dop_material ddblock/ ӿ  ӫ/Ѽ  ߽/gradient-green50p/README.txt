************************************************************
* Dynamic display block module theme: gradient-green50p    *
...
The gradient-green50p theme contains the following directories and files:

gradient-green50p5.jpg
README.txt
custom/
--boxes/
----boxes.css
...
------ddblock-cycle-block-content-gradient-green50p.tpl.php
------ddblock-cycle-pager-content.tpl.php
------ddblock-cycle-pager-content-gradient-green50p.tpl.php
------images/
--------readmore.png
--------readmore-hover.png
--------transparent_bg.png
------gradient-green50p/
--------ddblock-cycle-gradient-green50p.css
...
3.) Type gradient-green50p as the custom template name
