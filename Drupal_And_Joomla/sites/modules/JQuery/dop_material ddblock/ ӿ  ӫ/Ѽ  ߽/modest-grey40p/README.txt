************************************************************
* Dynamic display block module theme: modest-grey40p       *
* Copyright(c) 2009 P. Blaauw All rights reserved.         *
* Version 1.3(15-NOV-2009)                                 *
************************************************************
...
The modest-grey40p theme contains the following directories and files:
...
------ddblock-cycle-block-content-modest-grey40p.tpl.php
------ddblock-cycle-pager-content.tpl.php
------ddblock-cycle-pager-content-modest-grey40p.tpl.php
------images/
--------readmore.png
--------readmore-hover.png
--------transparent_bg.png
------modest-grey40p/
--------ddblock-cycle-modest-grey40p.css
...
3.) Type modest-grey40p as the custom template name
