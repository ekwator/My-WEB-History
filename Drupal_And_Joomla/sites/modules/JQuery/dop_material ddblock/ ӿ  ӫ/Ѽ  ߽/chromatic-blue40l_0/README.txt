************************************************************
* Dynamic display block module theme: chromatic-blue40l    *
...
The chromatic-blue40l theme contains the following directories and files:

chromatic-blue40l.jpg
README.txt
custom/
--modules/
----ddblock/
------ddblock-cycle-block-content.tpl.php
------ddblock-cycle-block-content-chromatic-blue40l.tpl.php
------ddblock-cycle-pager-content.tpl.php
------ddblock-cycle-pager-content-chromatic-blue40l.tpl.php
------images/
--------readmore.png
--------readmore-hover.png
--------transparent_bg.png
------chromatic-blue40l/
--------ddblock-cycle-chromatic-blue40l.css
--------images/
----------container_gradient.png
----------slide_text_gradient.png
...
3.) Type chromatic-blue40l (l from landscape) as the custom template name
