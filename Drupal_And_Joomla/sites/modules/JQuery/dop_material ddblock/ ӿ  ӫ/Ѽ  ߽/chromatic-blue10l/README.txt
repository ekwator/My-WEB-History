************************************************************
* Dynamic display block module theme: chromatic-blue10l    *
...
The chromatic-blue10l theme contains the following directories and files:

chromatic-blue10l.jpg
README.txt
custom/
--modules/
----ddblock/
------ddblock-cycle-block-content.tpl.php
------ddblock-cycle-block-content-chromatic-blue10l.tpl.php
------ddblock-cycle-pager-content.tpl.php
------ddblock-cycle-pager-content-chromatic-blue10l.tpl.php
------images/
--------readmore.png
--------readmore-hover.png
--------transparent_bg.png
------chromatic-blue10l/
--------ddblock-cycle-chromatic-blue10l.css
--------images/
...
3.) Type chromatic-blue10l (l from landscape) as the custom template name
