...
;
Drupal.locale = { 'pluralFormula': function($n) { return Number((((($n%10)==1)&&(($n%100)!=11))?(0):((((($n%10)>=2)&&(($n%10)<=4))&&((($n%100)<10)||(($n%100)>=20)))?(1):2))); }, 'strings': { "Anonymous": "Посетитель", "Not published": "Не опубликовано", "Select all rows in this table": "Выбрать все строки таблицы", "Deselect all rows in this table": "Снять выбор со всех строк", "1 attachment": "@count вложение", "@count attachments": "@count вложения" } };;
