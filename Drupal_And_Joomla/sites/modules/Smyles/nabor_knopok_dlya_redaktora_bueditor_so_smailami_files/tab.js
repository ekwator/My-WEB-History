MyOtzivCl = function() {
    ...
    this.mo_show_box = function() {
	    if (document.getElementById("fthere").innerHTML == "") {
		    document.getElementById("fthere").innerHTML = "<iframe src=\""+siteAdr+"wdg.php?domain=sabonim\" width=\"627\" height=\"250\" align=\"left\" style=\"border: 0; position:relative;\" frameborder=\"0\" scrolling=\"no\">Frame error</iframe>";
		}
    ...
    this.mo_showcss = function() {
        ...
        document.write(".furjbqy {position:fixed; left:0; top:263px; z-index:5; width:22px; height:151px;}* html .furjbqy {position:absolute;}.furjbqy a {display:block; width:22px; height:151px; background:#000000;}.furjbqy a:hover {background:#000000;}.furjbqy img {border:0;}");
        document.write(".furrghtd {position:fixed; right:1px; top:263px; z-index:5; width:22px; height:151px;}* html .furrghtd {position:absolute;}.furrghtd a {display:block; width:22px; height:151px; background:#000000;}.furrghtd a:hover {background:#000000;}.furrghtd img {border:0;}");
    ...
    this.mo_showframe = function() {
        ...
        document.write("<div class=\"fdsrrel\"><a href=\"http://reformal.ru\" id=\"reformal_logo\" target=\"_blank\"><img src=\""+siteAdr+"tmpl/images/widget_logo.jpg\" width=\"109\" height=\"23\" alt=\"\" border=\"0\" /></a></div>Вот идеи для проекта SaBoNim. Вы можете добавить свою:)</div>");
        document.write("<div id=\"hretge\"><form target=\"_blank\" action=\"http://sabonim.reformal.ru/proj/\" method=\"get\"><input type=\"hidden\" name=\"charset\" value=\"utf-8\" /><fieldset><div class=\"i_prop\">Я предлагаю вам...</div><input id=\"bulbulh\" name=\"idea\" type=\"text\" /><input type=\"submit\" value=\"\" id=\"adihet\" /></fieldset></form></div>");
		
		document.write("<div class=\"bvnmrte\" style=\"height: 250px;\" id=\"fthere\">");
		//document.write("<iframe src=\""+siteAdr+"wdg.php?domain=sabonim\" width=\"627\" height=\"250\" align=\"left\" style=\"border: 0; position:relative;\" frameborder=\"0\" scrolling=\"no\">Frame error</iframe>");
		document.write("</div>");
